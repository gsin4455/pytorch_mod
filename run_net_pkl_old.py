...
def train_net(train_loader=None, net=None, batch_size=128, n_epochs=5 ,learning_rate = 0.001,saved_model=None):
...
if __name__ == '__main__':
        ...
        data = torch.utils.data.TensorDataset(torch.from_numpy(x),torch.from_numpy(classes),torch.from_numpy(sns))
        ...
        if(args.train):
            ...
            train_net(data,nn,args.batch_size, args.steps, args.learning_rate,args.model_path)
            ...
            test_net(data,args.model_path,args.batch_size,'test_pred.csv')
